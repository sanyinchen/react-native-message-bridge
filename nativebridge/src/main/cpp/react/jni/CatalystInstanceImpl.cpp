    ...
    namespace react {
        ...
        void CatalystInstanceImpl::registerNatives() {
            registerHybrid({
                                   ...
                                   makeNativeMethod("jniLoadScriptFromDeltaBundle",
        ...
        void CatalystInstanceImpl::jniLoadScriptFromAssets(
            ...
            LOGD("load from url ==> %s", assetURL.c_str());
        ...
        void CatalystInstanceImpl::jniLoadScriptFromDeltaBundle(
            ...
            instance_->loadRAMBundle(
                    std::move(registry), deltaClient->getStartupCode(), sourceURL,
                    loadSynchronously);
        }

        void CatalystInstanceImpl::jniCallJSFunction(std::string module, std::string method,
